...
//                        .requestMatchers("security/new-user").permitAll()
//                        .requestMatchers("security/by-city").authenticated()
//                        .requestMatchers("security/by-name-surname").authenticated()
//                        .requestMatchers("security/by-age").permitAll()
//
//
//
//                )
